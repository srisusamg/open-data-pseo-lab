"""Change recipe over normalized facts; provider payloads never enter here."""
...
def derive_change_metric(
    ...
    *,
    ...
    facts = [
        {
            "entity_id": series["entity_id"], "metric_id": series["metric_id"],
            "value": start_value, "unit": series["unit"], "observation_year": start["year"],
            "provenance": source,
        },
        {
            "entity_id": series["entity_id"], "metric_id": series["metric_id"],
            "value": end_value, "unit": series["unit"], "observation_year": end["year"],
            "provenance": source,
        },
    ]
    return {
        ...
        "metric_slug": series["metric_slug"],
...
def change_path(entity: dict, start_year: int, end_year: int) -> str:
    return f"countries/{entity['slug']}/change/{start_year}-{end_year}/"
